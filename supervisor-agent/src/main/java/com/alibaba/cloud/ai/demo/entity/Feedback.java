...
public class Feedback {
    ...
    public Feedback(Long id, String orderId, Long userId, Integer feedbackType, 
                   Integer rating, String content, String solution, Date createdAt, Date updatedAt) {
        this.id = id;
